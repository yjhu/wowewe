...
CREATE TABLE IF NOT EXISTS wx_article_mult_article (
    ...
    article_mult_article_id int(10) unsigned NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
class MArticleMultArticle extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'article_mult_article_id' => Yii::t('app', 'ID'),
