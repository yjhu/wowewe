...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="./metronic/theme/assets/admin/layout/img/logo.png" alt="logo" class="logo-default"/>
			</a>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
								<li>
									...
									<span class="photo">
									<img src="./metronic/theme/assets/admin/layout3/img/avatar2.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Lisa Wong </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="./metronic/theme/assets/admin/layout3/img/avatar3.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Richard Doe </span>
								...
								<li>
									<a href="inbox.html?a=view">
									<span class="photo">
									<img src="./metronic/theme/assets/admin/layout3/img/avatar1.jpg" class="img-circle" alt="">
									</span>
									<span class="subject">
									<span class="from">
									Bob Nilson </span>
				...
				<li class="dropdown dropdown-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" class="img-circle" src="./metronic/theme/assets/admin/layout/img/avatar3_small.jpg"/>
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar3.jpg" alt="...">
								...
								<li class="media">
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar1.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar4.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar2.jpg" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar6.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar7.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar8.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar9.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar10.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="./metronic/theme/assets/admin/layout/img/avatar11.jpg" alt="...">
									<div class="media-body">
						...
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="page-quick-sidebar-chat-user-messages">
									<div class="post out">
										<img class="avatar" alt="" src="./metronic/theme/assets/admin/layout/img/avatar3.jpg"/>
										<div class="message">
											<span class="arrow"></span>
									...
									<div class="post in">
										<img class="avatar" alt="" src="./metronic/theme/assets/admin/layout/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow"></span>
