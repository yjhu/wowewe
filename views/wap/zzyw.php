...
<div data-role="page" id="page2" data-theme="c">
	...
	<div class="ui-field-contain">
	    ...
	    <fieldset data-role="controlgroup" data-type="horizontal" data-mini="ture" class="dcb">
	        ...
	        <label for="dcb3">30元</label>
	       	<input type="radio" name="dcb" id="dcb0" value="0">
	        <label for="dcb0">不需要</label>
	    </fieldset>
	</div>
...
$(document).on("pageinit", "#page2", function(){
	...
	$('#submitBtn').click(function(){
       ...
       var zzywStr = "";
       /**/
       if($("#zzyw1").is(":checked") == true)
       {
	       	//alert("漏话提醒!")
			zzywStr += "漏话提醒";
       }

       if($("#zzyw2").is(":checked") == true)
       {
	       	//alert("开机提醒!");
	       	zzywStr += "/开机提醒";
       }

       if($("#zzyw3").is(":checked") == true)
       {
       		//alert("炫铃!");
       		zzywStr += "/炫铃";
       }

       if($("#zzyw4").is(":checked") == true)
       {
       		//alert("联通秘书!");
       		zzywStr += "/联通秘书";
       }       

       if($("#zzyw5").is(":checked") == true)
       {
       		//alert("WO+视频PPTV定向流量!");
       		zzywStr += "/视频PPTV定向流量";
       }
       ...
       if($("#dcb2").is(":checked") == true)
       {
       		//alert("WO+视频PPTV定向流量!");
       		zzywStr += "/20元短彩包";
       }

       if($("#dcb3").is(":checked") == true)
       {
       		//alert("WO+视频PPTV定向流量!");
       		zzywStr += "/30元短彩包";
       }
       ...
       //alert( $("form#productForm").serialize() +"&cid="+cid+"&feeSum="+realFee+"&office="+office+"&selectNum="+selectNum+"&username="+username+"&usermobile="+usermobile+"&userid="+userid+"&address="+address+"&memo="+zzywStr);
		...
		$.ajax({
			...
			cache:false,
			dataType:'json',
			data: $("form#productForm").serialize() +"&cid="+cid+"&feeSum="+realFee+"&office="+office+"&selectNum="+selectNum+"&username="+username+"&usermobile="+usermobile+"&userid="+userid+"&address="+address+"&memo="+zzywStr,
