...
$(document).on("pageshow", "#page2", function(){
	...
	{			
		...
		$("#sel-num")[0].innerHTML="您选的号码 <span style='color:blue'>"+localStorage.getItem("num")+"</span>";
		//$("#sel-num").trigger('create');
	}

	if(localStorage.getItem("username") != null)
	{			
		$("#contact")[0].innerHTML="用户信息 <span style='color:blue'>"+localStorage.getItem("username")+"...</span>";
	}
