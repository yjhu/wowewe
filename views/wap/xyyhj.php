...
<div data-role="page" id="page1" data-theme="c">
	...
	<?php echo $this->render('header2', ['menuId'=>'menu4','title' => '校园优惠季']); ?>
	...
	<div data-role="content">
		...
		<div class="ui-field-contain">
			...
			<?php echo Html::dropDownList('office', 0, MOffice::getSchoolOfficeNameOption($gh_id, false),["id"=>"office"]); ?>
		</div>
...
<?php
	...
	$url = Yii::$app->wx->WxGetOauth2Url('snsapi_base', 'wap/showxyyhjinfo:'.Yii::$app->wx->getGhid());

	$myImg = Url::to("$assetsPath/share-icon.jpg", true);
	//$title = strip_tags($item->title);
	//$desc = strip_tags($item->title_hint);
	$title = strip_tags('校园优惠季');
	$desc = strip_tags('校园优惠季');
?>
