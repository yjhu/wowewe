...
<div data-role="page" id="page1" data-theme="c">
	...
	<?php echo $this->render('header2', ['menuId'=>'menu4','title' => '双12万能盛典']); ?>
	...
	<div data-role="content">
		...
		<?php if($cid==805) {?>
			...
			<p>苹果Apple iPhone6</p>
			<p>六模全兼容版 巅峰之作 岂止于大 ！64位架构 A8芯片 M8运动协处理器 iOS8 六模全兼容</p>
		<?php } elseif($cid==806) { ?>
			<img src="../web/show_res/double12-head.jpg" width="100%">
			<p>红米Note 4G</p>
			<p>联通4G 5.5英寸 全贴合IPS大屏 高通骁龙400系列 四核1.6GHz</p>
		<?php } elseif($cid==807) { ?>
			<img src="../web/show_res/double12-head.jpg" width="100%">
			<p>华为 Mate7</p>
			<p>4G全国套餐合约机 6英寸高清大屏 全金属材质 极简设计</p>
		<?php } elseif($cid==808) { ?>
			<img src="../web/show_res/double12-head.jpg" width="100%">
			<p>45G 上网卡</p>
...
<?php
	...
	$title = strip_tags('双12活动');
	$desc = strip_tags('双12活动');
?>
