...
<div class="device rel" id="device" >
    <div class="swiper-container" id="swiper-container">
      <div class="swiper-wrapper">
            ...
            <div class="main">
            <img src="./show_res/4gtaocan1.jpg?v1" >
            </div>
            <!--
            <div class="bg rel" >
            <div id="light" >
            ...
            -->
             ...
             <div class="swiper-slide rel" >
            	<div class="main" >
				<img class="lazy" data-original="./show_res/4gtaocan2.jpg?v1" src="./show_res/4gtaocan2.jpg?v1" >
				</div>
				<!--
        ...
        <a href="javascript:jump2order('4gtaocan')">
        <img class="lazy" data-original="./show_res/4gtaocan3.jpg?v7" src="./show_res/4gtaocan3.jpg?v7" >
        </a>
...
<script>
var url_base="<?php echo  Url::to(['wap/order4gtaocan'],true) ?>";
...
function jump2order(cat)
{
  if(cat=="4gtaocan")
  {
    location.href=url_base+"&cid=819&realFee=0&office=16";
  }
