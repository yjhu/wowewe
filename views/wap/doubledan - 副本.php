...
<div data-role="page" id="page1" data-theme="c">
	...
	<?php echo $this->render('header2', ['menuId'=>'menu4','title' => '双旦狂欢季']); ?>

	<div data-role="content">

		<?php if($cid==805) {?>
			<img src="../web/show_res/doubledan-head.jpg" width="100%">
			<p>苹果Apple iPhone6</p>
		...
		<?php } elseif($cid==810) { ?>
			<img src="../web/show_res/doubledan-head.jpg" width="100%">
			<p>100元5G本地流量上网卡</p>
			<p>市场价100元，活动价60元 联通3G上网卡套餐:60元/月移动卡号 发行地区:湖北 本地流量所在省:湖北 本地流量所在市:襄阳 内含资费: 月卡（含一个月资费）网速: 42M  是否包含设备:否 本地流量:归属地当地流量5G流量 全国漫游:仅限省内</p>	

		<?php } elseif($cid==811) { ?>
			<img src="../web/show_res/doubledan-head.jpg" width="100%">
			<p>3G半年卡</p>
			<p>市场价300元，活动价180元 通3G上网卡套餐:3GB/半年移动卡号 发行地区:湖北本地流量所在省:湖北 内含资费: 半年卡（含半年资费） 网速:42M 是否包含设备:否 本地流量:国内流量3GB 全国漫游:可漫游</p>	

		<?php } elseif($cid==812) { ?>
			<img src="../web/show_res/doubledan-head.jpg" width="100%">
			<p>6G年卡</p>
			<p>市场价600元，活动价360元 联通3G上网卡套餐:600元包6GB全年全国流量卡 移动卡号发行地区:湖北 本地流量所在省:湖北 内含资费:年卡（含整年资费）网速:42M 是否包含设备:否 本地流量:全国流量6GB 全国漫游:无全国漫游</p>	
		<?php } elseif($cid==808) { ?>
			<img src="../web/show_res/doubledan-head.jpg" width="100%">
			<p>45G 上网卡</p>
			<p>市场价600元，活动价360元 联通3G上网卡套餐:其他套餐 移动卡号发行地区: 湖北本地流量所在省:湖北本地 内含资费:年卡（含整年资费）网速:42M 是否包含设备:否 无本地流量:40G省内流量 全国漫游:5G国内流量</p>
		<?php } else { ?>
			<img src="../web/show_res/doubledan-head.jpg" width="100%">
				<p>96G 上网卡</p>
				<p>市场价1000元，活动价600元 联通3G上网卡套餐:全国+省内套餐移动 卡号发行地区:湖北 本地流量所在省:湖北 恩施内含资费: 年卡（含整年资费）网速:42M 是否包含设备:否 本地流量:90G省内流量 全国漫游:6G国内流量</p>
		<?php } ?>
...
<?php
	...
	$title = strip_tags('双旦狂欢季');
	$desc = strip_tags('双旦狂欢季');
?>
