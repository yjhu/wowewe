...
<ul class="nav nav-tabs">
	...
	<?php echo Html::a("昨天", ['stafftopbyrange', 'cur_date'=>$currentDate], []) ?>
	</li>

	<?php $currentDate = date("Y-m-d",strtotime("-2 day")); ?>
	<li <?php echo $cur_date == $currentDate ? 'class="active"' : ''; ?>>
	<?php echo Html::a("前天", ['stafftopbyrange', 'cur_date'=>$currentDate], []) ?>
	</li>

	<li <?php echo $cur_date == null ? 'class="active"' : ''; ?>>
	<?php echo Html::a("按时间范围成绩排行", ['stafftopbyrange'], []) ?>
	</li>
...
/*
	...
	<li <?php echo $cur_date == $currentDate ? 'class="active"' : ''; ?> >
	<?php echo Html::a("今天", ['stafftopbyrange', 'cur_date'=>$currentDate], []) ?>
	</li>
