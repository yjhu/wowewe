        ...
        */
        else if ($gh_id == MGh::GH_XIANGYANGUNICOM)
        {
            $menu = new \app\models\WxMenu([
                new \app\models\ButtonComplex('沃商城', [
                    //new \app\models\ButtonView('沃派校园套餐', Yii::$app->wx->WxGetOauth2Url('snsapi_base', "wap/cardxiaoyuan:{$gh_id}")),
                    new \app\models\ButtonView('双11合约机', Yii::$app->wx->WxGetOauth2Url('snsapi_base', "wap/mobilelist:{$gh_id}")),
                    new \app\models\ButtonView('双11上网卡', Yii::$app->wx->WxGetOauth2Url('snsapi_base', "wap/cardlist:{$gh_id}:kind=".MItem::ITEM_KIND_INTERNET_CARD)),
